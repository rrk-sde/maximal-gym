            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <button className="px-8 py-3 bg-[#1a1a1a] text-white font-semibold rounded-lg hover:bg-[#2a2a2a] transition-all border border-white/10">
                            View All FAQ
                        </button>
                    </div>
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, index) => (
                            <div
                                key={index}
                                className={`border-b border-white/10 transition-colors ${openIndex === index ? "bg-white/5 rounded-lg border-none" : ""
                                    }`}
                            >
                                <button
